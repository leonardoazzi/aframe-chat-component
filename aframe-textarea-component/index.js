...
/***/ (function(module, exports) {
	...
	AFRAME.registerComponent('textarea', {
	  ...
	  init: function () {
	    ...
	    this.el.addEventListener('click', this.focus.bind(this));
		  this.textarea.addEventListener('keyup', this.enter.bind(this));

      const sceneEl = document.querySelector("a-scene");


      const chatPlane = document.createElement('a-plane');
      const chat = document.createElement('a-entity');
    ...
    //   console.log(chat)
      ...
      chatPlane.setAttribute("position", "1 1.25 -1");
      chatPlane.setAttribute("color", "black")
      chatPlane.setAttribute("height", "0.1")
      chatPlane.setAttribute("width", "0.7")
	  chatPlane.setAttribute("chat")
      chat.setAttribute("position", "0.2 0 0.01")
    //   console.log(chat)
      chat.setAttribute("text", "value: chat")

      chatPlane.appendChild(chat);
    ...
    //   console.log(chat)
        ...
        chat.setAttribute("text", "value: "+this.text)
		chat.setAttribute("chat", "text: "+this.text)
        // console.log(chat)
	  ...
	  _initTextarea: function () {
	    this.textarea = document.createElement('textarea');
		  this.textarea.setAttribute("onkeydown", "handleEvent(event)");
